...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxDatefieldDirective, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }, { type: NxDateAdapter, decorators: [{
                    type: Optional
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxMultiYearViewComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ChangeDetectorRef }, { type: NxDateAdapter, decorators: [{
                    type: Optional
                }] }, { type: i2$2.Directionality, decorators: [{
                    type: Optional
                }] }]; }, propDecorators: { activeDate: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxCalendarComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: NxDatepickerIntl }, { type: NxDateAdapter, decorators: [{
                    type: Optional
                }] }, { type: i2$2.Directionality, decorators: [{
                    type: Optional
                }] }, { type: undefined, decorators: [{
...
class NxDatepickerToggleComponent {
    ...
    _watchStateChanges() {
        ...
        const inputDisabled = this.datepicker?._datepickerInput ? this.datepicker._datepickerInput._disabledChange : of();
        const inputReadonly = this.datepicker?._datepickerInput ? this.datepicker._datepickerInput._readonlyChange : of();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxDatepickerToggleComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: NxDatepickerIntl }, { type: i0.ChangeDetectorRef }, { type: DatepickerDefaultOptions, decorators: [{
                    type: Optional
                }, {
                    type: Inject,
                    args: [DATEPICKER_DEFAULT_OPTIONS]
                }] }, { type: i4.FocusMonitor }]; }, propDecorators: { _customIcon: [{
                type: ContentChild,
