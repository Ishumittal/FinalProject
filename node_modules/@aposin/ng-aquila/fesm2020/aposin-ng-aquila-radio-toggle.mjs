...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxRadioToggleButtonComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: NxRadioToggleComponent, decorators: [{
                    type: Inject,
                    args: [forwardRef(() => NxRadioToggleComponent)]
                }] }, { type: i0.Renderer2 }, { type: i0.ChangeDetectorRef }, { type: i1$1.UniqueSelectionDispatcher }, { type: i2$1.FocusMonitor }]; }, propDecorators: { disabled: [{
                type: Input,
                args: ['nxDisabled']
            }], selected: [{
                type: Input,
