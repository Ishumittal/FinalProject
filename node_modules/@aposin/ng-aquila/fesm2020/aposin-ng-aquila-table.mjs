...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSortHeaderComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: NxSortDirective, decorators: [{
                    type: Optional
                }] }, { type: NxSortHeaderIntl }, { type: i0.ChangeDetectorRef }, { type: i1.FocusMonitor }]; }, propDecorators: { _focusContainer: [{
                type: ViewChild,
                args: ['focusContainer']
            }], key: [{
                type: Input,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxTableComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ChangeDetectorRef }, { type: NxExpandableTableDirective, decorators: [{
                    type: Optional
