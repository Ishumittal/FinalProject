...
export declare class NxMessageToastService implements OnDestroy {
    ...
    constructor(_overlay: Overlay, _injector: Injector, _live: LiveAnnouncer, _parentMessageToastService: NxMessageToastService | null, _defaultConfig: NxMessageToastConfig | null);
    ...
    dismiss(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NxMessageToastService, [null, null, null, { optional: true; skipSelf: true; }, { optional: true; }]>;
    static ɵprov: i0.ɵɵInjectableDeclaration<NxMessageToastService>;
}
