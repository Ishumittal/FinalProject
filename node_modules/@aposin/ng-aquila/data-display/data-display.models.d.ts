 ...
 */
export declare type NxDataDisplayOrientation = 'vertical' | 'horizontal' | 'horizontal-columns';
/**
 * Sizes of the NxDataDisplayComponent.
 */
export declare type NxDataDisplaySize = 'small' | 'medium' | 'large';
/**
 ...
 */
export declare const DATA_DISPLAY_DEFAULT_OPTIONS: InjectionToken<DataDisplayDefaultOptions>;
