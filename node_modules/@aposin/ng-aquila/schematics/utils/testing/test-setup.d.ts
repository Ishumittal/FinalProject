...
export declare function createTestApp(runner: SchematicTestRunner, tree?: Tree, appOptions?: {}): Promise<UnitTestTree>;
 ...
 * @param tree
 */
export declare function addLibrary(options: any, tree: Tree): Promise<UnitTestTree>;
/**
