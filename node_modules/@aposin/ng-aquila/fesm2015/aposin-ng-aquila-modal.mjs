...
class NxModalContainer extends BasePortalOutlet {
    ...
    _restoreFocus() {
        ...
        if (this._config.restoreFocus && toFocus && typeof toFocus.focus === 'function') {
            ...
            // do anything.
            if (!activeElement || activeElement === ((_a = this._document) === null || _a === void 0 ? void 0 : _a.body) || activeElement === element || element.contains(activeElement)) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxModalContainer, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i1.FocusTrapFactory }, { type: i0.ChangeDetectorRef }, { type: Document, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [DOCUMENT]
                    }] }, { type: NxModalConfig }, { type: i1.FocusMonitor }];
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxDialogService, decorators: [{
        ...
        return [{ type: i1$1.Overlay }, { type: i0.Injector }, { type: NxModalConfig, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxModalCloseDirective, decorators: [{
        ...
        return [{ type: NxModalRef, decorators: [{
                        type: Optional
                    }] }, { type: i0.ElementRef }, { type: NxDialogService }];
