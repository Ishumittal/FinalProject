...
class NxMessageToastService {
     ...
     */
    open(text, config) {
        const currentConfig = Object.assign(Object.assign(Object.assign({}, new NxMessageToastConfig()), this._defaultConfig), config);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxMessageToastService, decorators: [{
        ...
        return [{ type: i1$1.Overlay }, { type: i0.Injector }, { type: i1.LiveAnnouncer }, { type: NxMessageToastService, decorators: [{
                        type: Optional
                    }, {
                        type: SkipSelf
