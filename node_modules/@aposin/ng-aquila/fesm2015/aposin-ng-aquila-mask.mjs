...
class NxMaskDirective {
    ...
    _onInputChange(event) {
        ...
        if (((_a = this._cursor) === null || _a === void 0 ? void 0 : _a.position) !== undefined) {
            input.setSelectionRange(this._cursor.position, this._cursor.position);
            this._cursor = null;
        }
        else if (((_b = this._cursor) === null || _b === void 0 ? void 0 : _b.selectionStart) !== undefined) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxIbanMaskDirective, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: NxMaskDirective, decorators: [{
                        type: Inject,
