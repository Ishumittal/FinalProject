...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxExpansionPanelComponent, decorators: [{
        ...
        return [{ type: NxAccordionDirective, decorators: [{
                        type: Optional
                    }, {
                        type: SkipSelf
                    }] }, { type: i0.ChangeDetectorRef }, { type: i2.UniqueSelectionDispatcher }, { type: i0.ViewContainerRef }];
    }, propDecorators: { negative: [{
                type: Input
            }], style: [{
                type: Input,
                args: ['nxStyle']
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxExpansionPanelHeaderComponent, decorators: [{
        ...
        return [{ type: NxExpansionPanelComponent, decorators: [{
                        type: Host
