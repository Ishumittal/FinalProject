...
class NxTooltipDirective {
    constructor(_overlay, _elementRef, _scrollDispatcher, _viewContainerRef, _ngZone, platform, _ariaDescriber, _focusMonitor, _dir, _defaultOptions, _defaultScrollStrategyFactory) {
        ...
        (_a = this._dir) === null || _a === void 0 ? void 0 : _a.change.pipe(takeUntil(this._destroyed)).subscribe(this._dirChangeHandler.bind(this));
        ...
        if (_defaultOptions === null || _defaultOptions === void 0 ? void 0 : _defaultOptions.position) {
    ...
    show(delay = this.showDelay) {
        var _a;
        if (this.disabled || !this.message || (this._isTooltipVisible() && !((_a = this._tooltipInstance) === null || _a === void 0 ? void 0 : _a.isDelayed()))) {
            return;
        }
    ...
    _handleTouchend() {
        var _a;
        this.hide((_a = this._defaultOptions) === null || _a === void 0 ? void 0 : _a.touchendHideDelay);
    }
    /**
    ...
    _updatePosition() {
        ...
        position.withPositions([
            Object.assign(Object.assign(Object.assign({}, origin), overlay), offset),
            ...fallbacks,
        ]);
    }
    /**
    ...
    _getVerticalFallbackPositionPairs(position) {
        ...
        const basePositionPair = Object.assign(Object.assign(Object.assign({}, this._getOrigin(position)), this._getOverlayPosition(position)), this._getOffset(position));
        ...
        verticalFallbackPositionPairs.push(Object.assign(Object.assign({}, basePositionPair), { originX: 'start', overlayX: 'start' }), Object.assign(Object.assign({}, basePositionPair), { originX: 'end', overlayX: 'end' }));
    ...
    _getHorizontalFallbackPositionPairs(position) {
        ...
        return [
            Object.assign(Object.assign(Object.assign({}, this._getOrigin(position)), this._getOverlayPosition(position)), offset),
        ];
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxTooltipDirective, decorators: [{
        ...
        return [{ type: i1$1.Overlay }, { type: i0.ElementRef }, { type: i2.ScrollDispatcher }, { type: i0.ViewContainerRef }, { type: i0.NgZone }, { type: i3.Platform }, { type: i4.AriaDescriber }, { type: i4.FocusMonitor }, { type: i5.Directionality, decorators: [{
                        type: Optional
