...
class NxSidepanelComponent {
    ...
    set opened(value) {
        ...
        (_a = this._wrapper) === null || _a === void 0 ? void 0 : _a._update();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidepanelComponent, decorators: [{
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i1.Directionality, decorators: [{
                        type: Optional
...
class NxSidepanelOuterContainerComponent {
    ...
    _getOpenState() {
        var _a;
        if (((_a = this._sidepanel) === null || _a === void 0 ? void 0 : _a.position) === 'static') {
    ...
    _getSidepanelWidth() {
        var _a, _b;
        if (((_a = this._sidepanel) === null || _a === void 0 ? void 0 : _a.position) === 'static' && ((_b = this._sidepanel) === null || _b === void 0 ? void 0 : _b.opened)) {
