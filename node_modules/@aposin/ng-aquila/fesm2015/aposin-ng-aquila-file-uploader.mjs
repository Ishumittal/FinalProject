...
class NxFileUploaderComponent {
    ...
    _syncDescribedByIds() {
        ...
        (_a = this.button) === null || _a === void 0 ? void 0 : _a.setDescribedByIds(ids);
    }
    _handleKeydownListRow(event) {
        var _a, _b;
        if (event.keyCode === DOWN_ARROW) {
            const nextFileItemRow = event.target.nextSibling;
            if ((_a = nextFileItemRow === null || nextFileItemRow === void 0 ? void 0 : nextFileItemRow.classList) === null || _a === void 0 ? void 0 : _a.contains('nx-file-uploader--file-row')) {
                event.preventDefault();
            ...
            if ((_b = previousFileItemRow === null || previousFileItemRow === void 0 ? void 0 : previousFileItemRow.classList) === null || _b === void 0 ? void 0 : _b.contains('nx-file-uploader--file-row')) {
                event.preventDefault();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxFileUploaderComponent, decorators: [{
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: i1$2.ErrorStateMatcher }, { type: NxFileUploaderIntl }, { type: i3.NgForm, decorators: [{
                        type: Optional
