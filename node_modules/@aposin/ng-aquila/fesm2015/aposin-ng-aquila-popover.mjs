...
class NxPopoverTriggerDirective {
        ...
        this.closeOnLeftViewport = new IntersectionObserver(entries => {
            entries.forEach(entry => {
                if (!entry.isIntersecting) {
                    this._ngZone.run(() => { var _a; return (_a = this.overlayRef) === null || _a === void 0 ? void 0 : _a.detach(); });
                }
    ...
    createOverlay() {
        ...
        if (!this.overlayRef) {
            ...
            overlayState.direction = ((_a = this._dir) === null || _a === void 0 ? void 0 : _a.value) || 'ltr';
            if (this._modal) {
    ...
    _getVerticalFallbackPositionPairs(direction) {
        ...
        const basePositionPair = Object.assign(Object.assign(Object.assign({}, this._getOrigin(direction)), this._getOverlayPosition(direction)), this._getOffset(direction));
    ...
    _getHorizontalFallbackPositionPairs(direction) {
        ...
        return [
            Object.assign(Object.assign(Object.assign({}, this._getOrigin(direction)), this._getOverlayPosition(direction)), offset),
        ];
    }
    _dirChangeHandler() {
        if (this.overlayRef) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxPopoverTriggerDirective, decorators: [{
        ...
        return [{ type: i1.Overlay }, { type: i0.ElementRef }, { type: i0.ViewContainerRef }, { type: i2$1.EventManager }, { type: i3$1.FocusTrapFactory }, { type: i3$1.FocusMonitor }, { type: i0.NgZone }, { type: i4.Platform }, { type: i5.Directionality, decorators: [{
                        type: Optional
                    }] }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [NX_POPOVER_SCROLL_STRATEGY]
                    }] }, { type: i0.ChangeDetectorRef }];
    }, propDecorators: { changeShow: [{
                type: Output,
