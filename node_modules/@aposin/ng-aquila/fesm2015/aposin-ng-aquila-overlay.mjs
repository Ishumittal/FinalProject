...
class NxOverlayContainerComponent extends BasePortalOutlet {
    ...
    restoreFocus() {
        ...
        if (this._config.restoreFocus && toFocus && typeof toFocus.focus === 'function') {
            ...
            // do anything.
            if (!activeElement || activeElement === ((_b = this._document) === null || _b === void 0 ? void 0 : _b.body) || activeElement === element || element.contains(activeElement)) {
                toFocus.focus();
            }
        }
        if (this._focusTrap) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxOverlayContainerComponent, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i1.FocusTrapFactory }, { type: Document, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [DOCUMENT]
...
class NxOverlayRef {
    ...
    waitForClose() {
        this._documentClickObservable
            .pipe(map(event => event.target), filter((target) => { var _a; return !((_a = this._overlayRef.overlayElement) === null || _a === void 0 ? void 0 : _a.contains(target)); }), takeUntil(this._afterClosed))
            .subscribe(() => {
            if (this.closeOnClickOutside) {
                this.close();
            }
...
class NxOverlayPositionBuilder {
    ...
    _getFallbackPositions(direction, config) {
        ...
        resolvedDirections.forEach(fallbackDirection => {
            ...
            fallbackPositions.push(Object.assign(Object.assign(Object.assign({}, origin), overlay), offset));
        });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxOverlayPositionBuilder, decorators: [{
        ...
        return [{ type: i1$1.Overlay }, { type: i2.Directionality, decorators: [{
                        type: Optional
                    }] }];
    } });
...
class NxOverlayService {
    ...
    _attachOverlayContainer(cdkOverlay, config) {
        var _a;
        const userInjector = (_a = config === null || config === void 0 ? void 0 : config.viewContainerRef) === null || _a === void 0 ? void 0 : _a.injector;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxOverlayService, decorators: [{
        ...
        return [{ type: i1$1.Overlay }, { type: i0.Injector }, { type: i2$1.Router }, { type: NxOverlayPositionBuilder }, { type: NxOverlayService, decorators: [{
                        type: Optional
                    }, {
                        type: SkipSelf
