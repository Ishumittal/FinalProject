...
class NxCheckboxGroupComponent {
    ...
    _updateSelectedCheckboxFromValue(initialisation = false) {
        ...
        if (((_a = this._checkboxes) === null || _a === void 0 ? void 0 : _a.length) && isValueSet) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxCheckboxGroupComponent, decorators: [{
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: i1.ErrorStateMatcher }, { type: i2.NgForm, decorators: [{
                        type: Optional
...
class NxCheckboxComponent {
    ...
    get name() {
        var _a;
        return (((_a = this.checkboxGroup) === null || _a === void 0 ? void 0 : _a.name) || this._name);
    }
    ...
    get disabled() {
        var _a;
        return ((_a = this.checkboxGroup) === null || _a === void 0 ? void 0 : _a.disabled) || this._disabled;
    }
    /**
    ...
    get labelSize() {
        var _a;
        return ((_a = this.checkboxGroup) === null || _a === void 0 ? void 0 : _a.labelSize) || this._labelSize;
    }
    /**
    ...
    get negative() {
        var _a;
        return ((_a = this.checkboxGroup) === null || _a === void 0 ? void 0 : _a.negative) || this._negative;
    }
    ...
    _controlInvalid() {
        ...
        if ((_a = this.checkboxGroup) === null || _a === void 0 ? void 0 : _a.ngControl) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxCheckboxComponent, decorators: [{
        ...
        return [{ type: i0.ChangeDetectorRef }, { type: i1.ErrorStateMatcher }, { type: NxCheckboxGroupComponent, decorators: [{
                        type: Optional
                    }] }, { type: i2.NgControl, decorators: [{
                        type: Optional
                    }, {
    ...
    }, propDecorators: { _checkboxLabelWrapper: [{
                type: ViewChild,
