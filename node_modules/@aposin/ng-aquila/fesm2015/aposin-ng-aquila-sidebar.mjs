...
import { EventEmitter, Component, ChangeDetectionStrategy, Optional, ViewChild, Output, Input, Host, NgModule } from '@angular/core';
import * as i1 from '@angular/cdk/bidi';
import * as i2 from '@angular/cdk/a11y';
import * as i3 from '@angular/common';
import { CommonModule } from '@angular/common';
import { NxButtonBase, NxButtonModule } from '@aposin/ng-aquila/button';
...
class NxSidebarFooterComponent {
}
NxSidebarFooterComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidebarFooterComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
NxSidebarFooterComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.1", type: NxSidebarFooterComponent, selector: "nx-sidebar-footer", host: { classAttribute: "nx-sidebar__footer" }, ngImport: i0, template: '<div class="nx-sidebar__footer-container"><ng-content></ng-content></div>', isInline: true, styles: [".nx-sidebar__footer-container ::ng-deep .nx-button,.nx-sidebar__footer-container ::ng-deep .nx-icon-button,.nx-sidebar__footer-container ::ng-deep .nx-sidebar__toggle-button{color:var(--sidebar-footer-button-color)}\n"] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidebarFooterComponent, decorators: [{
            type: Component,
            args: [{ selector: 'nx-sidebar-footer', host: {
                        class: 'nx-sidebar__footer',
                    }, template: '<div class="nx-sidebar__footer-container"><ng-content></ng-content></div>', styles: [".nx-sidebar__footer-container ::ng-deep .nx-button,.nx-sidebar__footer-container ::ng-deep .nx-icon-button,.nx-sidebar__footer-container ::ng-deep .nx-sidebar__toggle-button{color:var(--sidebar-footer-button-color)}\n"] }]
        }] });

class NxSidebarToggleComponent extends NxButtonBase {
    constructor(_cdr, _elementRef, _focusMonitor, _sidebar) {
...
NxSidebarModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidebarModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NxSidebarModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidebarModule, declarations: [NxSidebarComponent, NxSidebarFooterComponent, NxSidebarToggleComponent], imports: [CommonModule, NxIconModule, NxButtonModule], exports: [NxSidebarComponent, NxSidebarFooterComponent, NxSidebarToggleComponent] });
NxSidebarModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidebarModule, imports: [[CommonModule, NxIconModule, NxButtonModule]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.1", ngImport: i0, type: NxSidebarModule, decorators: [{
            type: NgModule,
            args: [{
...
//# sourceMappingURL=aposin-ng-aquila-sidebar.mjs.map
